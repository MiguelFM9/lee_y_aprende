 ...
 * @author Carlos
 */
public class ConsultarAreas extends javax.swing.JFrame {
        private DefaultTableModel modelo;
        private DaoArea daoArea = new DaoArea();

    /**
     * Creates new form ConsultarAreas
     */
    public ConsultarAreas() {
       modelo = new DefaultTableModel(new String []{"id","Descripcion"}, 0);
       List<String[]> lista= daoArea.consultarArea();
    ...
    private void initComponents() {
        ...
        setTitle("Lee & Aprende - Consultar áreas");
        ...
        jLabel2.setText("Consultar Áreas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarAreas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
